...
// Resolve __dirname in ESM and ensure we load the correct .env
...
if (!STREAM_API_KEY || !STREAM_SECRET) {
  console.error("Missing STREAM_API_KEY or STREAM_SECRET. Ensure BackEnd/.env exists and is loaded.");
